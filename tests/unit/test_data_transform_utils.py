import pytest
import pandas as pd
from src.data_transform.utils.utils import standardize_date_format, convert_id_to_string, sanitize_title_text, remove_rows_with_empty_titles_or_journals, remove_duplicate_ids_and_reindex
...
def test_remove_rows_with_empty_titles_or_journals():
    ...
    df = pd.DataFrame(data)
    result_df = remove_rows_with_empty_titles_or_journals(df, "title_column", "journal_column")
