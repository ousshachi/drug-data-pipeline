...
def build_relationships(mentions: List[Dict[str, str]]) -> Dict[str, Dict[str, List[Dict[str, str]]]]:
    """
    ...
    if not mentions:
        logging.warning("No mentions provided. Returning an empty relationships dictionary.")
        return {}
    ...
    for mention in mentions:
        ...
        relationships.setdefault(drug, {"publications": []})["publications"].append(publication_data)
